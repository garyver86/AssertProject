...

{
    public class AutomapperProfile : Profile
    {
        public AutomapperProfile()
        {
            ...
            CreateMap<TComplaintReason, ComplaintReasonDTO>();
            ...
            CreateMap<TnNotificationAction, NotificationActionDTO>();
            CreateMap<TnNotificationType, NotificationTypeDTO>();
            ...
            CreateMap<TmMessage, MessageDTO>()
                .ForMember(dest => dest.TypeMessage, opt => opt.MapFrom(src => src.MessageType != null ? src.MessageType.Name : null))
